...
- [Data Connection](./onboarding/data_connection.md)
- [Project Taxonomy](./onboarding/project_taxonomy.md)
...
- [Events Overview](./events/events_overview.md)
  - [Types](./events/events_overview.md)
  - [Stages](./events/events_overview.md)
- [Event Management](./events/event_management.md)
- [Event Detection](./events/event_detection.md)
- [Losses and Allocation](./events/event_losses.md)

# Key Performance Indicators
- [KPI Overview](./kpi/kpi_overview.md)
- [Industry Benchmark KPIs](./kpi/benchmark_kpis.md)
- [Contract KPIs](./kpi/contract_kpis.md)
...
- [PV Model Overview](./pv_performance/pv_model_overview.md)
  - [Plane of Array Irradiance](./pv_performance/poai/plane_of_array_irradiance.md)
    ...
    - [Reflected Horizontal Irradiance](./pv_performance/poai/reflected_horizontal_irradiance.md)
    - [Diffuse Horizontal Irradiance](./pv_performance/poai/diffuse_horizontal_irradiance.md)
    - [Tracker Rotation Angles](./pv_performance/poai/tracker_rotation_angles.md)
  - [Effective Irradiance](./pv_performance/effective_irradiance/effective_plane_of_array_irradiance.md)
  - [DC System Losses](./pv_performance/dc/dc_system_losses.md)
  - [AC System Losses](./pv_performance/ac/ac_system_losses.md)
...
# Data Quality
- [Data Quality Overviewt](./data_quality/overview.md)
